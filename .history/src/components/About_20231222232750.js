          ...
          <div className="flex-1 flex items-center xl:justify-center">
            <div className="xl:max-w-[571px]">
              ...
              <div className="flex items-center gap-x-8 mb-12">
                ...
                <button className="hidden xl:block bg-accent hover:bg-accent-hover rounded w-full h-16 uppercase font-medium text-white tracking-[-2px] text-[13px] max-w-[184px]">
                  See all cars
                </button>
              </div>
            </div>
